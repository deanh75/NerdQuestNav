...
namespace QuestNav.Core
{
    ...
    {
        #region Fields
        private AprilTagManager tagManager;

        private PoseData mtagPose;
        ...
        void Start()
        {
            ...
            tagManager = GetComponent<AprilTagManager>();
        }
        ...
        void LateUpdate()
        {
            ...
            if (networkConnection.IsConnected)
            {
                ...
                UpdateFrameData();
                networkConnection.PublishFrameData(frameIndex, timeStamp, position, rotation, eulerAngles, tagPose);
        ...
        private void UpdateFrameData()
        {
            ...
            mtagPose = tagManager.AprilTagPose();
            tagPose = mtagPose.ToDoubleArray();
        }
        /// <summary>
