...
public sealed class TagDetector : System.IDisposable
{
    ...
    #region Public methods
        ...
        public void ProcessImage(ImageU8 image, float fov, float tagSize)
        {
            if (image == null)
            {
                throw new ArgumentNullException(nameof(image), "Provided ImageU8 cannot be null.");
            }
