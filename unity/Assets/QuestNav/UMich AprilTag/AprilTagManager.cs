    ...
    public class AprilTagManager : MonoBehaviour
    {
        ...
        public PoseData AprilTagPose()
        {
            GCHandle handle = GCHandle.Alloc(
                m_webCamTextureManager.WebCamTexture.GetPixels32(),
                GCHandleType.Pinned
            );
